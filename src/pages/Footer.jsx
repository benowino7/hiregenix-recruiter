  ...
  return (
    ...
    <footer className="relative bg-gradient-to-b from-slate-950 to-black text-slate-300 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none opacity-20">
        ...
        <div className="absolute bottom-20 right-10 md:right-1/4 w-64 md:w-96 h-64 md:h-96 bg-blue-500/10 rounded-full blur-3xl animate-pulse-slow delay-1000"></div>
      </div>
      ...
      <div className="relative max-w-[90rem] mx-auto px-5 sm:px-8 lg:px-12 pt-16 pb-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12 mb-16">
          ...
          <div className="col-span-1 sm:col-span-2 lg:col-span-2">
            ...
            {/* Newsletter Signup */}
            <div>
              <h4 className="text-sm font-semibold uppercase tracking-wider mb-4 text-slate-200">
              ...
              <form className="flex flex-col sm:flex-row gap-3 max-w-lg">
                <input
                  ...
                  className="flex-1 px-4 py-3 bg-slate-800/60 border border-slate-700 rounded-xl focus:outline-none focus:border-[#0097A7] focus:ring-1 focus:ring-[#0097A7]/30 text-sm transition-all"
                  required
                />
                <button
                  type="submit"
          ...
          <div className="lg:col-start-3">
            ...
            <ul className="space-y-3 text-sm">
              <li><a href="/login?target=jobs" className="hover:text-[#0097A7] transition-colors">Post a Job</a></li>
              <li><a href="/login" className="hover:text-[#0097A7] transition-colors">Recruiter Login</a></li>
              <li><a href="/register" className="hover:text-[#0097A7] transition-colors">Start Hiring</a></li>
              <li><a href="/pricing" className="hover:text-[#0097A7] transition-colors">Pricing & Plans</a></li>
              <li><a href="/#testimonials" className="hover:text-[#0097A7] transition-colors">Success Stories</a></li>
              <li><a href="/contact" className="hover:text-[#0097A7] transition-colors">Contact Sales Team</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 mb-8 text-sm">
              <li><a href="/about" className="hover:text-[#0097A7] transition-colors">About HireGeniX</a></li>
              <li><a href="/contact" className="hover:text-[#0097A7] transition-colors">Contact Us</a></li>
              <li><a href="#" className="hover:text-[#0097A7] transition-colors">Blogs</a></li>
              <li><a href="#" className="hover:text-[#0097A7] transition-colors">Partners & Affiliates</a></li>
            </ul>

            <h4 className="text-sm font-semibold text-slate-200 mb-4">Legal</h4>
            <ul className="space-y-3 text-sm mb-8">
              <li>
                <button onClick={() => setShowTerms(true)} className="hover:text-[#0097A7] transition-colors flex items-center gap-2">
                  <FileText size={14} /> Terms of Use
                </button>
              </li>
              <li>
                <CookieSettingsButton className="hover:text-[#0097A7] transition-colors flex items-center gap-2" />
              </li>
            </ul>
            ...
            <div className="space-y-4 text-sm">
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="space-y-1">
                  <div><a href="tel:+16477888715" className="hover:text-[#0097A7] transition-colors">Care: 647-788-8715</a></div>
                  <div><a href="tel:+16479307516" className="hover:text-[#0097A7] transition-colors">Support: 647-930-7516</a></div>
                </div>
              </div>
              <div className="flex items-center gap-3">
                <Mail size={18} className="text-[#0097A7] flex-shrink-0" />
                <a href="mailto:support@hiregenix.ai" className="hover:text-[#0097A7] transition-colors">
        ...
        {/* Bottom Bar */}
        <div className="pt-10 border-t border-slate-800/70">
            ...
            <div className="flex items-center gap-4">
              {[
                ...
                <a
                  ...
                  className={`w-10 h-10 bg-slate-800/70 rounded-full flex items-center justify-center transition-all duration-300 ${color} hover:scale-110 hover:shadow-lg`}
